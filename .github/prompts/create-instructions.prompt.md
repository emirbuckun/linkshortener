...
description: Use this prompt to automatically generate concise agent instruction files (.md) and update the AGENTS.md registry when documenting new architectural layers or coding standards.
---
